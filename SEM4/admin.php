...
<body>
  ...
  <div class="header">
    ...
    <div class="title">E-Music</div>

    <div class="search-box" style="align-self:center">
    ...
    <div class="premium" id="premium">
      <form method="POST">
        <button style='font-size:24px; outline:none;cursor:pointer; padding:10px; color:#d8d8d8;font-weight:bold;background:#282828; border:none;' name="premium"><i class='fas fa-crown' style="padding: 5px;"></i>Premium</button>
      </form>
    </div>
  ...
  <div id="already">
    ...
    <div class="info-contents">
      ...
      ?>
      <label><b>Membership No : </b>&nbsp;<?php echo " ";
                                          echo $row['membership_no']; ?></label><br>
      <label><b>Start Date :</b>&nbsp;<?php echo " ";
                                      echo $row['start_date']; ?></label><br>
      <label><b>Expiry Date &nbsp;&nbsp;: </b>&nbsp;<?php echo " ";
                                                    echo $row['expiry_date']; ?></label>
    </div>
  ...
  <div id="info">
    ...
    <div class="info-contents">
      ...
      <label><b>Firstname : </b>&nbsp;<?php echo " ";
                                echo $row['firstname']; ?></label><br>
      <label><b>Lastname :</b>&nbsp;<?php echo " ";
                                    echo $row['lastname']; ?></label><br>
      <label><b>Email-id &nbsp;&nbsp;: </b>&nbsp;<?php echo " ";
  ...
  <div class="content">
    ...
    <div class="sidenav">
      ...
      <div class="side_style"><a href="#liked_songs" onclick="openDisplay('liked_songs')">Liked Songs</a></div><br>
      <div class="side_style"><a href="#trending" onclick="openDisplay('trending')">Trending</a></div><br>
    ...
    <div class="main">
      ...
      <div class="column3">
          ...
          <input type="button" onclick="closeDisplay('trending')" value="close" class="close1"></input>
        ...
        <?php
         ...
         $sql = "Select song_name,count(song_name) AS Count from liked group by song_name order by Count desc";
         $result= mysqli_query($con,$sql);
         ?><div class="kontent"><?php 
...
mysqli_close($con);
      ...
      <div id="liked_songs" class="liked hide">
        ...
        <h1>Songs liked by you </h1>
        <div class="decor flexbox">
        ...
        <?php
          $imagepath = "images/";
          echo "<img src='" . $imagepath . $row['song_image'] . "' height='200' width='200'/>";?><br><br>
          <div class="fixing" style="font-size:23px">‏‏‎ ‎‏‏‎ ‎<?php echo $row['song_name'];?></div>
          <?php
          echo '<br>';?></div><?php
        }
        ...
        <div class="column3">
          ...
          <!--<i class="fas fa-times-circle"></i>-->
          <input type="button" onclick="closeDisplay('liked_songs')" value="close" class="close1"></input>
      ...
      <div class="sections visible" id="sections">
        ...
        <div class="bekhayali not_visible" id="bekhayali">
          ...
          <!--<div class="album_name">
            <i class="fas fa-times-circle"></i>
            <input type="button" onclick="goBack('bekhayali')" value="close" class="close"></input>
          </div>-->
          ...
          <div class="album">
            ...
            <div class="card">
              ...
              <div class="actions">
                ...
                <a href="music/bekhayali.mp3" download="Bekhayali">
                  <img src="images/download_icon.jpg" class="download_icon download_btn" onclick="download_func('Bekhayali')">
                </a>
              </div>
            ...
            <div class="card">
              ...
              <div style="cursor: pointer" onclick="selectSong('tumhechahne.mp3')">Tujhe Chahne Lage</div>
            </div>
        ...
        <div class="villain not_visible" id="villain">
          ...
          <div class="album">
            <div class="card column">
              ...
              <div style="cursor: pointer" onclick="selectSong('galliyan.mp3')">Ek Villain</div>
            </div>
      ...
      <input type="button" onclick="goBack('villain')" value="close" class="close"></input>
        ...
        <div class="baaghi not_visible" id="baaghi">
          ...
          <div class="album">
            ...
            <div class="card">
              ...
              <div style="cursor: pointer" onclick="selectSong('sabtera.mp3')">Sab Tera</div>
            </div>
      ...
      <div class="column3">
      <input type="button" onclick="goBack('baaghi')" value="close" class="close"></input>
      ...
      <div class="column3">
        <input type="button" onclick="goBack('yejawani')" value="close" class="close"></input>
      </div>
          </div>
      ...
      <div class="column3">
      <input type="button" onclick="goBack('satyamev')" value="close" class="close"></input>
      ...
      <div class="column3">
      <input type="button" onclick="goBack('lukachuppi')" value="close" class="close"></input>
      ...
      <div class="column3">
      <input type="button" onclick="goBack('soty')" value="close" class="close"></input>
      ...
      <div class="column3">
      <input type="button" onclick="goBack('tiger')" value="close" class="close"></input>
      ...
      <div class="column3">
      <input type="button" onclick="goBack('ashiqui')" value="close" class="close"></input>
      ...
      <div class="column3">
      <input type="button" onclick="goBack('housefull')" value="close" class="close"></input>
      ...
      <div class="column3">
      <input type="button" onclick="goBack('arijitSingh')" value="close" class="close"></input>
        ...
        <div class="shreyaGhoshal not_visible" id="shreyaGhoshal">
          ...
          <div class="column3">
            <input type="button" onclick="goBack('shreyaGhoshal')" value="close" class="close"></input>
        ...
        <div class="mohitChauhan not_visible" id="mohitChauhan">
          ...
          <div class="column3">
              <input type="button" onclick="goBack('mohitChauhan')" value="close" class="close"></input>
          </div>
          </div>
        </div>
        ...
        <div class="rahatKhan not_visible" id="rahatKhan">
          ...
          <div class="column1">
            ...
            <div class="column3">
          <input type="button" onclick="goBack('rahatKhan')" value="close" class="close"></input>
        ...
        <div class="shaan  not_visible" id="shaan">
          ...
          <div class="column3">
      <input type="button" onclick="goBack('shaan')" value="close" class="close"></input>
        ...
        <div class="sonuNigam not_visible" id="sonuNigam">
          ...
          <div class="column3">
      <input type="button" onclick="goBack('sonuNigam')" value="close" class="close"></input>
        ...
        <div class="sunidhiChauhan not_visible" id="sunidhiChauhan">
          ...
          <div class="column3">
            <input type="button" onclick="goBack('sunidhiChauhan')" value="close" class="close"></input>
        ...
        <div class="nehaKakkar not_visible" id="nehaKakkar">
          ...
          <div class="column3">
      <input type="button" onclick="goBack('nehaKakkar')" value="close" class="close"></input>
        ...
        <div class="kanikaKapoor not_visible" id="kanikaKapoor">
          ...
          <div class="column3">
      <input type="button" onclick="goBack('kanikaKapoor')" value="close" class="close"></input>
        ...
        <div class="arRahman  not_visible" id="arRahman">
          ...
          <div class="column3">
      <input type="button" onclick="goBack('arRahman')" value="close" class="close"></input>
            ...
            <div class="card">
              ...
              <div class="actions">
                ...
                <a href="music/perfect.mp3" download="Perfect">
                  <img src="images/download_icon.jpg" class="download_icon" onclick="download_func('Perfect')">
                </a>
              </div>

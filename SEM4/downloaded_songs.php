...
<head>
  ...
  <link href="downloaded_songs.css" rel="stylesheet">
  ...
  <div class="content_2">
    ...
    <div class="main_2">
      ...
      <?php
         ...
         $sql = "select distinct song_name from liked ";
         $result= mysqli_query($con,$sql);

         while($row=mysqli_fetch_array($result))
        {?>
          
          <ul><i class="fa fa-music" aria-hidden="true"></i>‏‏‎ - <?php $sum = 0;
          echo $row['song_name'];
          $x = $row['song_name'];
          /*echo '</br>';*/
           
          $sql2 = "select downloaded from liked where song_name = '".$x."' ";
          $result2 = mysqli_query($con,$sql2);
          while($row1=mysqli_fetch_array($result2))
          {?>
              <li class="fixing"><?php $sum += $row1['downloaded'];
          }
            echo $sum;?></li></ul><?php /*echo '</br>';*/ 
        } 
      ?>
      </div>
      <h1>User Wise</h1>
      ...
      <?php
        ...
        {?>
          ...
          $sql2 = "select song_name,downloaded from liked where liked_email = '".$x."' ";
          $result2 = mysqli_query($con,$sql2);
          while($row1=mysqli_fetch_array($result2))
          {?>
              <li class="fixing"><i class="fa fa-music" aria-hidden="true"></i>‏‏‎ ‎‏‏‎ ‎<?php echo $row1['song_name'];?> - <?php echo $row1['downloaded'];?></li>
              <?php
              echo '</br>';
          }?></ul><?php
